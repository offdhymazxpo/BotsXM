...
//
const BotName = 'BotsXM'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/offdhymaz'; // Nama Instagramlu cok
const whatsapplu = '+6285796582392'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung kouta'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
